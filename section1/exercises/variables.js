...
/* I decided to use a String for firstName because names are words. I used a Boolean for
   isHungry becuase that can be either true or false. Finally, I used a Number for numberOfPets
   because that variable name suggst an numeric value.*/
...
console.log(junkFoodSnacks * healthySnacks);
